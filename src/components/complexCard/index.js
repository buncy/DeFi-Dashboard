    ...
    <div className="rounded w-full max-w-sidebar overflow-hidden shadow-lg mb-5 py-5 ">
      <div className="px-4 flex flex-row ">
        ...
        <div className="px-4">
          ...
          <p className="text-gray-400 text-base">{props.secondaryText}</p>
          <p className="text-gray-400 text-base pt-2">{props.subText}</p>
        </div>
      </div>
      <div className="flex flex-row pt-4 ">
        <button className="w-32 ml-6  rounded border border-solid border-gray-300 sidebar-btn h-9">
          Vote
        </button>
